...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("/home/TUUSUARIO/telegram_bot.log"),  # Actualiza la ruta con tu nombre de usuario
...
BOT_TOKEN = os.environ.get("7864524092:AAEqJDOJflP5lkwNPkExK0eP1_zZKnsIuGs")
if not BOT_TOKEN:
...
Los párrafos diarios se envían a las 9:00 AM (UTC).
"""
...
Recibirás un párrafo diario a las 9:00 AM (UTC).
...
def main() -> None:
    ...
    updater = Updater(7864524092:AAEqJDOJflP5lkwNPkExK0eP1_zZKnsIuGs)
    ...
    scheduler.start()
    logger.info("Programador configurado para enviar párrafos diarios a las 9:00 AM (UTC)")
